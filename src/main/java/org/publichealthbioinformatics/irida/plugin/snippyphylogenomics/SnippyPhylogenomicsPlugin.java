...
import static ca.corefacility.bioinformatics.irida.model.workflow.analysis.type.BuiltInAnalysisTypes.PHYLOGENOMICS;

/**
 * An example {@link IridaPlugin} implementation which will extract some
 * information from the sequencing reads.
 */
public class SnippyPhylogenomicsPlugin extends Plugin {
	...
	public SnippyPhylogenomicsPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#52153c"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new SnippyPhylogenomicsPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
